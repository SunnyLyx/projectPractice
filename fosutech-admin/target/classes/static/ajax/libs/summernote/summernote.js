...
(function (global, factory) {
  ...
  var isSupportTouch = (('ontouchstart' in window) ||
      (navigator.MaxToucfosutechoints > 0) ||
      (navigator.msMaxToucfosutechoints > 0));
  ...
  var WrappedRange = /** @class */ (function () {
       ...
       * @return {WrappedRange}
       */
      WrappedRange.prototype.wrapBodyInlineWitfosutechara = function () {
      ...
      WrappedRange.prototype.insertNode = function (node) {
          var rng = this.wrapBodyInlineWitfosutechara().deleteContents();
  ...
  var Bullet = /** @class */ (function () {
      ...
      Bullet.prototype.indent = function (editable) {
          var _this = this;
          var rng = range.create(editable).wrapBodyInlineWitfosutechara();
  ...
  var Typing = /** @class */ (function () {
      ...
      Typing.prototype.insertParagraph = function (editable, rng) {
          ...
          rng = rng.wrapBodyInlineWitfosutechara();
          // finding paragraph
  ...
  var VideoDialog = /** @class */ (function () {
      ...
      VideoDialog.prototype.createVideoNode = function (url) {
          ...
          if (ytMatch && ytMatch[1].length === 11) {
              ...
              $video = $$1('<iframe>')
                  .attr('frameborder', 0)
                  .attr('src', 'https://www.facebook.com/plugins/video.pfosutech?href=' + encodeURIComponent(fbMatch[0]) + '&show_text=0&width=560')
