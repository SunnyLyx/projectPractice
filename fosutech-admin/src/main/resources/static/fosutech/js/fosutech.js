    ...
    $.extend({
    	...
    	table: {
            ...
            dropdownToggle: function (value) {
                ...
                actions.push('<i class="fa fa-fw fa-cog"></i>&nbsp;<span class="fa fa-fw fa-chevron-left"></span></button>');
                actions.push('<ul class="dropdown-menu" style="padding-left: 3px; position: absolute; top: -40%; right: 100%; left: auto;">');
                actions.push(value.replace(/<a/g,"<li style='display: inline'><a").replace(/<\/a>/g,"</a></li>"));
                actions.push('</ul>');
                actions.push('</div>');
                return actions.join('');
            },
            ...
            importExcel: function(formId) {
            	...
            	layer.open({
            		...
            		content: $('#' + currentId),
            		btn: ['<i class="fa fa-fw fa-check"></i> 导入', '<i class="fa fa-fw fa-remove"></i> 取消'],
            		// 弹层外区域关闭
            		shadeClose: true,
    	...
    	modal: {
            ...
            openOptions: function (options) {
                ...
                layer.open({
                    ...
                    content: _url,
                    shadeClose: true,
                    btn: ['<i class="fa fa-fw fa-check"></i> 确认', '<i class="fa fa-fw fa-close"></i> 关闭'],
                    yes: function (index, layero) {
