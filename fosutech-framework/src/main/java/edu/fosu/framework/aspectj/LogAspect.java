package edu.fosu.framework.aspectj;

import edu.fosu.common.annotation.Log;
import edu.fosu.common.enums.BusinessStatus;
import edu.fosu.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(edu.fosu.common.annotation.Log)")
